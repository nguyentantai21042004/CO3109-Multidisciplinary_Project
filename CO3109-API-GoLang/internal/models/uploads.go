...
type Upload struct {
	...
	FromLocation  string      `boil:"from_location" json:"from_location" toml:"from_location" yaml:"from_location"`
...
var UploadTableColumns = struct {
	...
	FromLocation:  "uploads.from_location",
...
var UploadWhere = struct {
	...
	FromLocation  whereHelperstring
	...
	Name:          whereHelperstring{field: "\"uploads\".\"name\""},
	Path:          whereHelperstring{field: "\"uploads\".\"path\""},
	Source:        whereHelperstring{field: "\"uploads\".\"source\""},
	FromLocation:  whereHelperstring{field: "\"uploads\".\"from_location\""},
...
var (
	uploadAllColumns            = []string{"id", "name", "path", "source", "from_location", "public_id", "created_user_id", "created_at", "updated_at", "deleted_at"}
	uploadColumnsWithoutDefault = []string{"name", "path", "source", "from_location", "created_user_id"}
	uploadColumnsWithDefault    = []string{"id", "public_id", "created_at", "updated_at", "deleted_at"}
