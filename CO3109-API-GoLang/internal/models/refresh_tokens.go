...
var (
	refreshTokenAllColumns            = []string{"id", "user_id", "token", "expires_at", "created_at", "deleted_at"}
	refreshTokenColumnsWithoutDefault = []string{"user_id", "token", "expires_at"}
	refreshTokenColumnsWithDefault    = []string{"id", "created_at", "deleted_at"}
