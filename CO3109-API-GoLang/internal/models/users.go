...
type User struct {
	...
	IsVerified   null.Bool   `boil:"is_verified" json:"is_verified,omitempty" toml:"is_verified" yaml:"is_verified,omitempty"`
...
var UserWhere = struct {
	...
	IsVerified   whereHelpernull_Bool
	...
	IsVerified:   whereHelpernull_Bool{field: "\"users\".\"is_verified\""},
	AvatarURL:    whereHelpernull_String{field: "\"users\".\"avatar_url\""},
	Provider:     whereHelpernull_String{field: "\"users\".\"provider\""},
	ProviderID:   whereHelpernull_String{field: "\"users\".\"provider_id\""},
...
var (
	userAllColumns            = []string{"id", "email", "password_hash", "full_name", "is_verified", "avatar_url", "provider", "provider_id", "otp", "otp_expired_at", "role_id", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"email", "role_id"}
	userColumnsWithDefault    = []string{"id", "password_hash", "full_name", "is_verified", "avatar_url", "provider", "provider_id", "otp", "otp_expired_at", "created_at", "updated_at", "deleted_at"}
...
func (userL) LoadSessions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qmhelper.WhereIsNull(`sessions.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadUserRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_roles`),
		qm.WhereIn(`user_roles.user_id in ?`, argsSlice...),
		qmhelper.WhereIsNull(`user_roles.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
